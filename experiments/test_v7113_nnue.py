"""Correctness gate for v7.1.1.3 incremental mix NNUE.

    python experiments/test_v7113_nnue
"""
...
def check_mix_startpos() -> str | None:
    ...
    if int(MIX[0]) != 0:
        return f"expected absolute MIX flag, got {int(MIX[0])}"
    return None
