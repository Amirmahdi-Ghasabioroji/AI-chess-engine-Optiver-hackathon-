...
import evaluate
from book import pack_move, unpack_move
...
class Engine:
    ...
    def _pvs(self, board: chess.Board, depth: int, alpha: int, beta: int, ply: int) -> int:
        ...
        if best_move and not board.is_capture(unpack_move(best_move)):
            ...
            m = unpack_move(best_move)
            self.history[side][m.from_square][m.to_square] += depth * depth
    ...
    def _ordered_moves(
        ...
        for move in it:
            ...
            if packed == tt_move:
                ...
                score = 100_000 + 10 * evaluate.SEE_VAL[victim] - evaluate.SEE_VAL[attacker]
                if move.promotion:
                    score += 5000 * move.promotion
            elif packed == k1:
                score = 90_000
            elif packed == k2:
                score = 80_000
                ...
                if move.promotion:
                    score += 70_000 + 100 * move.promotion
